...
I am currently a postdoctoral associate at Duke University, working with Prof. Yiran Chen and Prof. Hai (Helen) Li. I obtained my Ph.D. degree from the Computer Science and Engineering (CSE) at Shanghai Jiao Tong University in Sep. 2023, under the supervision of Prof. Jingwen Leng. My research interests include computer architecture and high-performance computing. I have published more than 10 papers at top-tier international conferences, like ISCA, MICRO, ASPLOS, and SC, with a total of <a href='https://scholar.google.com/citations?user=sp5VwJoAAAAJ'>the Google Scholar citations <strong><span id='total_cit'>200</span></strong></a> (You can also use Google Scholar badge <a href='https://scholar.google.com/citations?user=sp5VwJoAAAAJ'><img src="https://img.shields.io/endpoint?url={{ url | url_encode }}&logo=Google%20Scholar&labelColor=f6f6f6&color=9cf&style=flat&label=citations"></a>). 
